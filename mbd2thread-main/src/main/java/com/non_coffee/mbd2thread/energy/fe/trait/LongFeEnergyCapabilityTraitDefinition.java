...
import com.non_coffee.mbd2thread.gui.editor.configurator.SILongConfigurator;
...
@LDLRegister(name = "mbd2thread_long_fe_container", group = "trait")
public class LongFeEnergyCapabilityTraitDefinition extends SimpleCapabilityTraitDefinition {
    ...
    @Configurable(
            ...
            tips = "config.definition.trait.mbd2thread_long_fe_container.auto_io.tooltip"
    )
    ...
    public void buildConfigurator(ConfiguratorGroup father) {
        father.addConfigurators(new SILongConfigurator(
                "config.definition.trait.mbd2thread_long_fe_container.capacity",
                () -> capacity,
                ...
                5000L,
                true,
                "config.definition.trait.mbd2thread_long_fe_container.capacity.tooltip"
        ));
        father.addConfigurators(new SILongConfigurator(
                "config.definition.trait.mbd2thread_long_fe_container.max_receive",
                () -> maxReceivePerTick,
                ...
                512L,
                true,
                "config.definition.trait.mbd2thread_long_fe_container.max_receive.tooltip"
        ));
        father.addConfigurators(new SILongConfigurator(
                "config.definition.trait.mbd2thread_long_fe_container.max_extract",
                () -> maxExtractPerTick,
                ...
                512L,
                true,
                "config.definition.trait.mbd2thread_long_fe_container.max_extract.tooltip"
        ));
    ...
    public void initTraitUI(ITrait trait, WidgetGroup group) {
        ...
        WidgetUtils.widgetByIdForEach(group, "^%s$".formatted(prefix), ProgressWidget.class, energyBar -> {
            energyBar.setHoverTooltips(Component.translatable(
                    "config.definition.trait.mbd2thread_long_fe_container.ui_limits",
            ...
            energyBar.setDynamicHoverTips(value -> LocalizationUtils.format(
                    "config.definition.trait.mbd2thread_long_fe_container.ui_container_hover",
