...
public final class BuilderMaterialBindings {
    private static final String KEY_ITEM_DIM = "mbd2thread_bind_item_dim";
    private static final String KEY_ITEM_POS = "mbd2thread_bind_item_pos";
    private static final String KEY_FLUID_DIM = "mbd2thread_bind_fluid_dim";
    private static final String KEY_FLUID_POS = "mbd2thread_bind_fluid_pos";
    public static final String KEY_SLOW_BUILD = "mbd2thread_slow_build";
